-- PCG Maroc AI — PostgreSQL baseline schema (v16)
...
CREATE TABLE IF NOT EXISTS users (
    id            TEXT PRIMARY KEY,
    firm_id       TEXT REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,        -- NULL for super_admin
...
CREATE TABLE IF NOT EXISTS clients (
    id          TEXT PRIMARY KEY,
    firm_id     TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    name        TEXT NOT NULL,
    ice         TEXT,
    if_number   TEXT,
    address     TEXT,
    assigned_to TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,          -- accountant
...
CREATE TABLE IF NOT EXISTS invoices (
    id              TEXT PRIMARY KEY,
    firm_id         TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    client_id       TEXT NOT NULL REFERENCES clients(id) DEFERRABLE INITIALLY DEFERRED,
    ...
    is_duplicate_of TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    model           TEXT,
    duration_ms     INTEGER,
    ...
    posted_by       TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    posted_at       TEXT,
    is_archived     INTEGER NOT NULL DEFAULT 0,
    created_at      TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS notifications (
    id         TEXT PRIMARY KEY,
    firm_id    TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    user_id    TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,           -- NULL = whole firm
    kind       TEXT NOT NULL,                       -- invoice_processed | validation_failed | duplicate_detected | export_ready
    message    TEXT NOT NULL,
    invoice_id TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS insights (
    id         TEXT PRIMARY KEY,
    firm_id    TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    invoice_id TEXT NOT NULL REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS documents (
    id                TEXT PRIMARY KEY,
    firm_id           TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    client_id         TEXT REFERENCES clients(id) DEFERRABLE INITIALLY DEFERRED,      -- NULL = firm-level document
    invoice_id        TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,     -- set when routed through the invoice pipeline
    ...
    parent_id         TEXT REFERENCES documents(id) DEFERRABLE INITIALLY DEFERRED,    -- previous version of this document
    created_at        TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS bank_accounts (
    id          TEXT PRIMARY KEY,
    firm_id     TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    client_id   TEXT REFERENCES clients(id) DEFERRABLE INITIALLY DEFERRED,        -- NULL = the firm's own account
    name        TEXT NOT NULL,
    bank_name   TEXT,
...
CREATE TABLE IF NOT EXISTS bank_statements (
    id                TEXT PRIMARY KEY,
    firm_id           TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    bank_account_id   TEXT NOT NULL REFERENCES bank_accounts(id) DEFERRABLE INITIALLY DEFERRED,
    filename          TEXT NOT NULL,
    format            TEXT NOT NULL,                -- csv | camt053 | mt940
    imported_by       TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS bank_transactions (
    ...
    firm_id            TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    bank_account_id    TEXT NOT NULL REFERENCES bank_accounts(id) DEFERRABLE INITIALLY DEFERRED,
    statement_id       TEXT REFERENCES bank_statements(id) DEFERRABLE INITIALLY DEFERRED,
    date               TEXT NOT NULL,
    value_date         TEXT,
    label              TEXT NOT NULL,
    reference          TEXT,
    ...
    matched_invoice_id TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    match_confidence   REAL,
    match_explanation  TEXT,
    matched_by         TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,   -- NULL = automatic suggestion
    matched_at         TEXT,
    is_duplicate_of    TEXT REFERENCES bank_transactions(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS expense_attachments (
    id          TEXT PRIMARY KEY,
    firm_id     TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    claim_id    TEXT NOT NULL REFERENCES expense_claims(id) DEFERRABLE INITIALLY DEFERRED,
    filename    TEXT NOT NULL,
    uploaded_by TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    created_at  TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS supplier_connections (
    ...
    connected_by TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    last_sync_at TEXT,
    created_at   TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS lettrage_lines (
    lettrage_id TEXT NOT NULL REFERENCES lettrages(id) DEFERRABLE INITIALLY DEFERRED,
    firm_id     TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS account_reviews (
    ...
    firm_id        TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    account_number TEXT NOT NULL,
    reviewed_by    TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS manual_entry_lines (
    entry_id       TEXT NOT NULL REFERENCES manual_entries(id) DEFERRABLE INITIALLY DEFERRED,
    line_idx       INTEGER NOT NULL,
    account_number TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS accounting_periods (
    ...
    closed_by    TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    closed_at    TEXT,
    created_at   TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS posting_batches (
    id              TEXT PRIMARY KEY,
    firm_id         TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    client_id       TEXT REFERENCES clients(id) DEFERRABLE INITIALLY DEFERRED,
    invoice_id      TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    manual_entry_id TEXT REFERENCES manual_entries(id) DEFERRABLE INITIALLY DEFERRED,
    bank_transaction_id TEXT REFERENCES bank_transactions(id) DEFERRABLE INITIALLY DEFERRED,
    ...
    posted_by       TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    posted_at       TEXT NOT NULL,
    reversal_of     TEXT REFERENCES posting_batches(id) DEFERRABLE INITIALLY DEFERRED,
    reversed_by     TEXT REFERENCES posting_batches(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS posting_lines (
    batch_id          TEXT NOT NULL REFERENCES posting_batches(id) DEFERRABLE INITIALLY DEFERRED,
    line_idx          INTEGER NOT NULL,
    account_number    TEXT NOT NULL,
    account_label     TEXT NOT NULL,
    side              TEXT NOT NULL,             -- DEBIT | CREDIT
...
CREATE TABLE IF NOT EXISTS tax_rules (
    id               TEXT PRIMARY KEY,
    firm_id          TEXT REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,   -- NULL = platform/default rule
...
CREATE TABLE IF NOT EXISTS payment_allocations (
    ...
    firm_id             TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    invoice_id          TEXT NOT NULL REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    bank_transaction_id TEXT NOT NULL REFERENCES bank_transactions(id) DEFERRABLE INITIALLY DEFERRED,
    amount_cents        INTEGER NOT NULL CHECK(amount_cents > 0),
    allocated_by        TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS invoice_approval_steps (
    ...
    invoice_id  TEXT NOT NULL REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    firm_id     TEXT NOT NULL REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,
    workflow_id TEXT NOT NULL REFERENCES approval_workflows(id) DEFERRABLE INITIALLY DEFERRED,
    step_index  INTEGER NOT NULL,
    approver_id TEXT NOT NULL REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    approved_at TEXT,
    note        TEXT,
...
CREATE TABLE IF NOT EXISTS account_rules (
    id                 TEXT PRIMARY KEY,
    firm_id            TEXT REFERENCES firms(id) DEFERRABLE INITIALLY DEFERRED,  -- NULL = platform Moroccan PCG rule
    ...
    effective_to       TEXT,
    legal_basis        TEXT,
    approved_by        TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    is_active          INTEGER NOT NULL DEFAULT 1,
    created_at         TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS fixed_assets (
    ...
    client_id            TEXT REFERENCES clients(id) DEFERRABLE INITIALLY DEFERRED,
    invoice_id           TEXT REFERENCES invoices(id) DEFERRABLE INITIALLY DEFERRED,
    posting_batch_id     TEXT REFERENCES posting_batches(id) DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS depreciation_runs (
    ...
    created_by  TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    created_at  TEXT NOT NULL,
    UNIQUE(firm_id, client_id, period)
);

CREATE TABLE IF NOT EXISTS depreciation_lines (
    run_id       TEXT NOT NULL REFERENCES depreciation_runs(id) DEFERRABLE INITIALLY DEFERRED,
    asset_id     TEXT NOT NULL REFERENCES fixed_assets(id) DEFERRABLE INITIALLY DEFERRED,
    amount_cents INTEGER NOT NULL CHECK(amount_cents >= 0),
...
CREATE TABLE IF NOT EXISTS close_adjustment_checks (
    ...
    note        TEXT,
    updated_by  TEXT REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED,
    updated_at  TEXT NOT NULL,
